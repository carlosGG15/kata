...
public class OrderQueryConstants {
    ...
    public static final String GET_ORDERS_QUERY = """
                SELECT
                o.order_id as orderId, op.name AS orderPriority, o.order_date AS orderDate, r.name as region, c.name as country, ot.name as orderType,
